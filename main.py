...
def empMenu():
    ...
    headingLabel.place(relx=0.25,rely=0.15, relwidth=0.5, relheight=0.4)
    
    btn1 = Button(root,text="Add Book Details",bg='black', fg='white', command=addBooks)
    btn1.place(relx=0.25,rely=0.3, relwidth=0.45,relheight=0.1)
    
    btn2 = Button(root,text="Delete Book",bg='black', fg='white', command=delete)
    btn2.place(relx=0.25,rely=0.4, relwidth=0.45,relheight=0.1)
    
    btn3 = Button(root,text="View Book List",bg='black', fg='white', command=View)
    btn3.place(relx=0.25,rely=0.5, relwidth=0.45,relheight=0.1)
    
    btn4 = Button(root,text="Search Book",bg='black', fg='white', command=searchBook)
    btn4.place(relx=0.25,rely=0.6, relwidth=0.45,relheight=0.1)
    
    btn5 = Button(root,text="Issue Book to Student",bg='black', fg='white', command = issueBook)
    btn5.place(relx=0.25,rely=0.7, relwidth=0.45,relheight=0.1)
    
    btn6 = Button(root,text="Return Book",bg='black', fg='white', command = returnBook)
    btn6.place(relx=0.25,rely=0.8, relwidth=0.45,relheight=0.1)
...
headingFrame1 = Frame(root,bg="#333945",bd=4)
headingFrame1.place(relx=0.2,rely=0.1,relwidth=0.6,relheight=0.16)

headingFrame2 = Frame(headingFrame1,bg="#EAF0F1")
headingFrame2.place(relx=0.01,rely=0.05,relwidth=0.98,relheight=0.9)

headingLabel = Label(headingFrame2, text="WELCOME TO EVOLVE LIBRARY", fg='black')
